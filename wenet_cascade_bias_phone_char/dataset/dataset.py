...
def Dataset(data_type,
    ...
    """ yaml conf add
    context_mode: 1
    bpe_dict: '/home/work_nfs5_ssd/kxhuang/wenet-encoder_decoder_bias/examples/librispeech/s0/data/lang_char/train_960_unigram5000_units.txt'
    pad_conf:
        context_len_min: 1
        context_len_max: 3
        context_list_valid: '/home/work_nfs5_ssd/kxhuang/wenet-encoder_decoder_bias/examples/librispeech/s0/data/processed_context_valid'
        context_list_test: '/home/work_nfs5_ssd/kxhuang/wenet-encoder_decoder_bias/examples/librispeech/s0/data/processed_context_test'
    """ 
