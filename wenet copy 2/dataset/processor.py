...
def context_generate(key_list, context_dic, label=None, context_len_min=1, context_len_max=3, context_mode=0, bpe_set=None, context_list_valid=None, context_list_test=None, pos_per_bartch=1.0):
...
def padding(data, context_len_min=2, context_len_max=4, context_mode=0, bpe_set=None, context_dic=None, context_list_valid=None, context_list_test=None, pos_per_batch=1.0):
