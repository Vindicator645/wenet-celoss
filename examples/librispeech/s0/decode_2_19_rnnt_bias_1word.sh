...
dir=exp/2_19_rnnt_bias_loss_2_class_both_more_layer
...
decode_checkpoint=$dir/14cgb .pt
      ...
      {
        {
          ...
          # context_mode=1
          test_dir=$dir/${test}_${mode}_${decode_checkpoint}_context${context_mode}_off
          mkdir -p $test_dir
